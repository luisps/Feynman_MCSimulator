...
#endif    // if defined __CSTATE_MP__ OR __CSTATE_VCHAR__
// unsigned long long instead of CState for all_paths()
...
myReal layer_sample (TCircuitLayer* layer, int l, unsigned long long current_state,
    ...
    myReal lwR = 1.f, lwI = 0.f, pdf=1.f;
    unsigned long long lnext_state=0;
