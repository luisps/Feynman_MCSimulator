...
inline float gate_id_sample (int i_qb, int& o_qb, float &wR, float &wI) {
    o_qb = i_qb;
    wR = 1.f;
    wI = 0.f;
    return 1.f;
...
inline float gate_x_sample (int i_qb, int& o_qb, float &wR, float &wI) {
    o_qb = 1 - i_qb;
    wR = 1.f;
    wI = 0.f;
    return 1.f;
...
inline float gate_y_sample (int i_qb, int& o_qb, float &wR, float &wI) {
    o_qb = 1 - i_qb;
    wI = (i_qb == 0 ? 1.f : -1.f );
    wR = 0.f;
    return 1.f;
...
inline float gate_y_sample_back (int i_qb, int& o_qb, float &wR, float &wI) {
    o_qb = 1 - i_qb;
    wI = (i_qb == 0 ? -1.f : 1.f );
    wR = 0.f;
    return 1.f;
...
inline float gate_z_sample (int i_qb, int& o_qb, float &wR, float &wI) {
    o_qb = i_qb;
    wR = (i_qb == 0 ? 1.f : -1.f );
    wI = 0.f;
    return 1.f;
...
inline float gate_s_sample (int i_qb, int& o_qb, float &wR, float &wI) {
    o_qb = i_qb;
    wR = (i_qb == 0  ? 1.f : 0.f );
    wI = (i_qb == 1  ? 1.f : 0.f );
    return 1.f;
...
inline float gate_t_sample (int i_qb, int& o_qb, float &wR, float &wI) {
    o_qb = i_qb;
...
inline float gate_id2_sample (int i_qbs, int& o_qbs, float &wR, float &wI) {
    o_qbs = i_qbs;
    wR = 1.f;
    wI = 0.f;
    return 1.f;
...
inline float gate_cx_sample (int i_qbs, int& o_qbs, float &wR, float &wI) {
...
inline float gate_cz_sample (int i_qbs, int& o_qbs, float &wR, float &wI) {
    o_qbs = i_qbs;
    wR = (i_qbs==3 ? -1.f : 1.f);
    wI = 0.f;
    return 1.f;
